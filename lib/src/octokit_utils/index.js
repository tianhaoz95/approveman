...
function reviewChange(context, action) {
...
function maybeApproveChange(context) {
    return __awaiter(this, void 0, void 0, function () {
        var changedFiles, rules;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getChangedFiles(context)];
                case 1:
                ...
                case 2:
                    ...
                    if (!rule_matcher_1.ownsAllFiles(rules.directoryMatchingRules, changedFiles, getUserInfo(context), context)) return [3 /*break*/, 4];
                    context.log.info('The user owns all modified files, approve PR.');
                    return [4 /*yield*/, reviewChange(context, 'APPROVE')];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 4:
