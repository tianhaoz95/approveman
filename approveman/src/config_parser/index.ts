...
export function parseOwnershipRules (rules: any, context: Context<Webhooks.WebhookPayloadPullRequest>): OwnershipRules {
...
export async function getOwnershipRules (context: Context<Webhooks.WebhookPayloadPullRequest>): Promise<OwnershipRules> {
